  ...
  return (
    <div>
      <div className="relative my-10 sm:my-50 h-[700px] flex items-center justify-center">
        ...
        <div className="absolute sm:top-[220px] sm:right-[25%] top-[280px] right-[5%] text-xs sm:text-xl py-2 px-5 rounded-full font-display font-semibold text-white border-amber-600 border-2 transition-all duration-300 ease-in-out hover:bg-gradient-to-r from-zinc-900 to-zinc-900 hover:from-yellow-500 hover:to-orange-600 hover:text-zinc-900 flex items-center gap-2">
          <FaShoppingCart /> E-commerce Setup
        </div>
        <div className="absolute sm:top-[450px] sm:left-[27%]  top-[390px] left-[1%]  text-xs sm:text-xl py-2 px-5 rounded-full font-display font-semibold text-white border-amber-600 border-2 transition-all duration-300 ease-in-out hover:bg-gradient-to-r from-zinc-900 to-zinc-900 hover:from-yellow-500 hover:to-orange-600 hover:text-zinc-900 flex items-center gap-2">
          <FaPencilAlt /> Brand Identity Design
        </div>
        <div className="absolute top-[450px] right-[27%]  text-xs sm:text-xl py-2 px-5 rounded-full font-display font-semibold text-white border-amber-600 border-2 transition-all duration-300 ease-in-out hover:bg-gradient-to-r from-zinc-900 to-zinc-900 hover:from-yellow-500 hover:to-orange-600 hover:text-zinc-900 flex items-center gap-2">
          <FaMobileAlt /> Mobile-Responsive Layouts
        </div>
        <div className="absolute sm:top-[580px] sm:right-[25%] top-[390px] right-[5%]  text-xs sm:text-xl py-2 px-5 rounded-full font-display font-semibold text-white border-amber-600 border-2 transition-all duration-300 ease-in-out hover:bg-gradient-to-r from-zinc-900 to-zinc-900 hover:from-yellow-500 hover:to-orange-600 hover:text-zinc-900 flex items-center gap-2">
          <FaMagic /> UI/UX Enhancements
        </div>
        {/* <div className="absolute sm:top-[580px] sm:left-[25%] top-[390px] right-[2%]  text-xs sm:text-xl py-2 px-5 rounded-full font-display font-semibold text-white border-amber-600 border-2 transition-all duration-300 ease-in-out hover:bg-gradient-to-r from-zinc-900 to-zinc-900 hover:from-yellow-500 hover:to-orange-600 hover:text-zinc-900 flex items-center gap-2">
          <FaMagic /> UI/UX Enhancements
        </div> */}
        <div className="absolute sm:top-[580px] sm:left-[25%] top-[220px] left-[30%] text-xs sm:text-xl py-2 px-5 rounded-full font-display font-semibold text-white border-amber-600 border-2 transition-all duration-300 ease-in-out hover:bg-gradient-to-r from-zinc-900 to-zinc-900 hover:from-yellow-500 hover:to-orange-600 hover:text-zinc-900 flex items-center gap-2">
          <FaBrain /> SEO Basics Integration
        </div>

        {/* Additional Elements (unchanged) */}
        <div className="absolute sm:top-[120px] sm:left-[10%] top-[150px] left-[10%]  text-gray-400 font-extrabold text-xs sm:text-xl bg- border-gray-400 border-2 py-2 px-5 rounded-full">
          Fast Delivery
        </div>
        <div className="absolute sm:top-[120px] sm:right-[15%] top-[150px] right-[15%] text-gray-400 font-extrabold text-xs sm:text-xl bg- border-gray-400 border-2 py-2 px-5 rounded-full">
          Global Reach
        </div>
        <div className="absolute sm:top-[450px] sm:left-[8%] top-[510px] left-[8%] text-gray-400 font-extrabold text-xs sm:text-xl bg- border-gray-400 border-2 py-2 px-5 rounded-full">
          Custom Solutions
        </div>
        <div className="absolute sm:top-[450px] sm:right-[10%] top-[510px] right-[8%] text-gray-400 font-extrabold text-xs sm:text-xl bg- border-gray-400 border-2 py-2 px-5 rounded-full">
          Creative Designs
        </div>
      </div>
    </div>
